...
export function get_monitor_workspace_windows(workspace, monitor, allow_unrelated) {
    let _windows = [];
...
export function move_back_window(window) {
...
export function is_primary(window) {
...
export function is_related(meta_window) {
